...
namespace Tests\Dameerv\SyliusSupplierPlugin\Behat\Context\Ui\Admin;
...
use Tests\Dameerv\SyliusSupplierPlugin\Behat\Page\Admin\Vendor\CreatePageInterface;
use Tests\Dameerv\SyliusSupplierPlugin\Behat\Page\Admin\Vendor\IndexPageInterface;
use Tests\Dameerv\SyliusSupplierPlugin\Behat\Page\Admin\Vendor\UpdatePageInterface;
...
final class ManagingVendorsContext implements Context
{
     ...
     * @throws \FriendsOfBehat\PageObjectExtension\Page\UnexpectedPageException
     */
    public function iWantToModifyVendor(SupplierInterface $vendor): void
    {
     ...
     * @throws \FriendsOfBehat\PageObjectExtension\Page\UnexpectedPageException
     */
    public function vendorShouldAppearInTheAdmin(SupplierInterface $vendor): void
    {
        $this->indexPage->open();
