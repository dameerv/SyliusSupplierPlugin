...
final class Version20211102135222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dameerv_supplier_email ADD CONSTRAINT IF NOT EXISTS FK_F58E945BF603EE73 FOREIGN KEY (supplier_id) REFERENCES dameerv_supplier (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE dameerv_supplier_translation ADD CONSTRAINT IF NOT EXISTS FK_5F5AE1AB2C2AC5D3 FOREIGN KEY (translatable_id) REFERENCES dameerv_supplier (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE dameerv_supplier_channels ADD CONSTRAINT IF NOT EXISTS FK_42A3C6D272F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id)');
        $this->addSql('ALTER TABLE dameerv_supplier_channels ADD CONSTRAINT IF NOT EXISTS FK_42A3C6D2F603EE73 FOREIGN KEY (supplier_id) REFERENCES dameerv_supplier (id)');
        $this->addSql('ALTER TABLE sylius_product ADD IF NOT EXISTS supplier_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sylius_product ADD CONSTRAINT IF NOT EXISTS FK_677B9B74F603EE73 FOREIGN KEY (supplier_id) REFERENCES dameerv_supplier (id)');
