...
final class Version20211102135222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_email ADD CONSTRAINT FK_F58E945BF603EE73 FOREIGN KEY (supplier_id) REFERENCES dameerv_supplier (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_translation ADD CONSTRAINT FK_5F5AE1AB2C2AC5D3 FOREIGN KEY (translatable_id) REFERENCES dameerv_supplier (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_channels ADD CONSTRAINT FK_42A3C6D272F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id)');
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_channels ADD CONSTRAINT FK_42A3C6D2F603EE73 FOREIGN KEY (supplier_id) REFERENCES dameerv_supplier (id)');
        $this->addSql('ALTER TABLE IF EXISTS sylius_product ADD supplier_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE IF EXISTS sylius_product ADD CONSTRAINT FK_677B9B74F603EE73 FOREIGN KEY (supplier_id) REFERENCES dameerv_supplier (id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS IDX_677B9B74F603EE73 ON sylius_product (supplier_id)');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_email DROP FOREIGN KEY FK_F58E945BF603EE73');
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_translation DROP FOREIGN KEY FK_5F5AE1AB2C2AC5D3');
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_channels DROP FOREIGN KEY FK_42A3C6D2F603EE73');
        $this->addSql('ALTER TABLE IF EXISTS sylius_product DROP FOREIGN KEY FK_677B9B74F603EE73');
        ...
        $this->addSql('ALTER TABLE IF EXISTS sylius_product DROP supplier_id');
    }
}
