...
final class Version20211102135222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dameerv_supplier_email DROP CONSTRAINT IF EXISTS FK_F58E945BF603EE73');
        ...
        $this->addSql('ALTER TABLE dameerv_supplier_translation DROP CONSTRAINT IF EXISTS FK_5F5AE1AB2C2AC5D3');
        ...
        $this->addSql('ALTER TABLE dameerv_supplier_channels DROP CONSTRAINT IF EXISTS FK_42A3C6D272F5A1AA');
        ...
        $this->addSql('ALTER TABLE dameerv_supplier_channels DROP CONSTRAINT');
        ...
        $this->addSql('CREATE INDEX CONCURRENTLY IF NOT EXISTS IDX_677B9B74F603EE73 ON sylius_product (supplier_id)');
    }
