...
final class Version20230421190409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_product ADD CONSTRAINT FK_653BEDDA4584665A FOREIGN KEY (product_id) REFERENCES dameerv_supplier (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_product ADD CONSTRAINT FK_653BEDDA2ADD6D8C FOREIGN KEY (supplier_id) REFERENCES sylius_product (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_channels ADD CONSTRAINT FK_E8830B32ADD6D8C FOREIGN KEY (supplier_id) REFERENCES dameerv_supplier (id)');
        $this->addSql('ALTER TABLE IF EXISTS dameerv_supplier_channels ADD CONSTRAINT FK_E8830B372F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id)');
