...
final class Version20230421190409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dameerv_supplier_product ADD CONSTRAINT IF NOT EXISTS  FK_653BEDDA4584665A FOREIGN KEY (product_id) REFERENCES dameerv_supplier (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE dameerv_supplier_product ADD CONSTRAINT IF NOT EXISTS FK_653BEDDA2ADD6D8C FOREIGN KEY (supplier_id) REFERENCES sylius_product (id) ON DELETE CASCADE');
