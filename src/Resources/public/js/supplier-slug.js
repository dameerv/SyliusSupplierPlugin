(function ($) {
    ...
    $.fn.extend({
        supplierSlugGenerator: function () {
            let timeout;

            $('[name*="supplier"][name*="[name]"]').on('input', function() {
            ...
            $('.toggle-supplier-slug-modification').on('click', function(e) {
                e.preventDefault();
